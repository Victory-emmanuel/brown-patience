    ...
    <>
      <div id="hero">
        <div className="lg:pb-32 xs:pb-12 ss:pb-16 ss:px-0  lg:px-12 bg-extraClr">
          <div className=" m-auto px-6 pt-24 ss:py-12 md:px-12 lg:pt-[4.8rem] lg:px-7">
            <div className="grid lg:grid-cols-2 sm:grid-cols-1 items-center gap-12 px-2 md:px-0">
              ...
              <div className="lg:text-left  sm:text-center sm:mt-12 place-self-center lg:col-span-1">
                <h1 className="max-w-2xl  mb-8 font-extrabold tracking-tight leading-none md:text-4xl ss:text-3xl xs:text-2xl   sm:text-4xl xl:text-5xl dark:text-white">
